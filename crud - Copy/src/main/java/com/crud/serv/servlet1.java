...
public class servlet1 extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(action.equals("insert")) {
			...
			int i = emp.insert(e);
			if(i==1) {
				out.print("<h1 style=\"color: green; text-align:center;padding: top 50px;\">Inserted data successfully.</h1>");
				out.println("<a href=\"options.html\" style=\"background-color: green;color:white;border-radius:10px; padding:10px;margin-left:45%;><button \style=\"background-color: green;color:white; text-align:center;\">Home Page</button></a>");
			}
			else {
		...
		// update email on the basis of id
			...
			if(i==1) {
				out.print("<h1 style=\"color: green; text-align:center;padding: top 50px;\">Updated data successfully.</h1>");
				out.println("<a href=\"options.html\" style=\"background-color: green;color:white;border-radius:10px; padding:10px;margin-left:45%;><button \style=\"background-color: green;color:white; text-align:center;\">Home Page</button></a>");
			}
			else {
				out.println("<h1 style=\"color: red; text-align:center;padding: top 50px;\">Some Problem Occured.</h1>");
				out.println("<a href=\"options.html\" style=\"background-color: green;color:white;border-radius:10px; padding:10px;margin-left:45%;><button \style=\"background-color: green;color:white; text-align:center;\">Home Page</button></a>");			}
		} 
		...
		// delete record on the basis of id
			...
			if(i==1) {
				out.print("<h1 style=\"color: green; text-align:center;padding: top 50px;\"> Deleted data successfully.</h1>");
				out.println("<a href=\"options.html\" style=\"background-color: green;color:white;border-radius:10px; padding:10px;margin-left:45%;><button \style=\"background-color: green;color:white; text-align:center;\">Home Page</button></a>");
			}
			else {
				out.print("<h1 style=\"color: red; text-align:center;padding: top 50px;\">Some Problem Occured.</h1>");
